...
if(loam_livox_CONFIG_INCLUDED)
  return()
endif()
set(loam_livox_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(loam_livox_SOURCE_PREFIX /root/loam_livox/src)
  set(loam_livox_DEVEL_PREFIX /root/loam_livox/devel)
  set(loam_livox_INSTALL_PREFIX "")
  set(loam_livox_PREFIX ${loam_livox_DEVEL_PREFIX})
else()
  set(loam_livox_SOURCE_PREFIX "")
  set(loam_livox_DEVEL_PREFIX "")
  set(loam_livox_INSTALL_PREFIX /root/loam_livox/install)
  set(loam_livox_PREFIX ${loam_livox_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'loam_livox' is deprecated")
...
set(loam_livox_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/root/loam_livox/src/include;/usr/include/eigen3;/usr/include/pcl-1.8;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  set(loam_livox_INCLUDE_DIRS "")
  set(_include_dirs "/root/loam_livox/src/include;/usr/include/eigen3;/usr/include/pcl-1.8;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'LinJiarong <ziv.lin.ljr@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${loam_livox_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'loam_livox' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'loam_livox' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/loam_livox/src/${idir}'.  ${_report}")
    endif()
    _list_append_unique(loam_livox_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND loam_livox_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND loam_livox_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT loam_livox_NUM_DUMMY_TARGETS)
      set(loam_livox_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::loam_livox::wrapped-linker-option${loam_livox_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR loam_livox_NUM_DUMMY_TARGETS "${loam_livox_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::loam_livox::wrapped-linker-option${loam_livox_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND loam_livox_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/loam_livox/devel/lib;/root/catkin_ws/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(loam_livox_LIBRARY_DIRS ${lib_path})
      list(APPEND loam_livox_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'loam_livox'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND loam_livox_LIBRARIES ${lib})
    endif()
  endif()
...
set(loam_livox_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${loam_livox_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 loam_livox_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${loam_livox_dep}_FOUND)
      find_package(${loam_livox_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${loam_livox_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(loam_livox_INCLUDE_DIRS ${${loam_livox_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(loam_livox_LIBRARIES ${loam_livox_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${loam_livox_dep}_LIBRARIES})
  _list_append_deduplicate(loam_livox_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(loam_livox_LIBRARIES ${loam_livox_LIBRARIES})

  _list_append_unique(loam_livox_LIBRARY_DIRS ${${loam_livox_dep}_LIBRARY_DIRS})
  list(APPEND loam_livox_EXPORTED_TARGETS ${${loam_livox_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${loam_livox_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
